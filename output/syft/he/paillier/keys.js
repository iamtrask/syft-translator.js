{
	...
	SecretKey.prototype.serialize = function () {
		return (function () {
			return pickle.dumps(this.sk);
		}).call(this);
	};
	SecretKey.prototype.deserialize = function () {
		return (function () {
			return new SecretKey(pickle.loads(b));
		}).call(this);
	};
}
{
	...
	PublicKey.prototype.serialize = function () {
		return (function () {
			return pickle.dumps(this.pk);
		}).call(this);
	};
	PublicKey.prototype.deserialize = function () {
		return (function () {
			return new PublicKey(pickle.loads(b));
		}).call(this);
	};
}
{
	...
	KeyPair.prototype.deserialize = function () {
		...
		return (function () {
			this.public_key = new PublicKey(pickle.loads(pubkey));
			this.secret_key = new SecretKey(pickle.loads(seckey));
